...
//   setTimeout(next, 2000); //delay all requests by 2 sec
// });
...
//if these fields are missing then show the text in green. in the console (pointless) just gives an error message used in the ManageCoursepage
function validateCourse(course) {
  if (!course.title) return "Hey! You forgot to add a title for your course";
